...
$(function() {
    let logementId = $(".masthead img").attr('data-logementId')

    // Requête AJAX pour récupérer les images dans la BDD
    $.ajax({
        url: 'pictures.php',
        type: 'POST',
        dataType : 'json',
        data : {'logementId' : logementId},
        success: function(response) {

            // Boucle sur chaque image et la stock
